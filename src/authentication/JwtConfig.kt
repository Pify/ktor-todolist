package com.pify.authentication
...
class JwtConfig(jwtSecret: String) {
    ...
    companion object {
        //jwt config
        private const val jwtIssuer = "com.pify"
        private const val jwtRealm = "com.pify.todolist"
     ...
     */
    fun genereateToken(user: JwtUser): String = JWT.create()
